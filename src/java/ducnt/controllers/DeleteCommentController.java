        ...
        try {
            ...
            if (userDTO != null) {
                ...
                if (dao.delete(commentID)) {
                    if (!articleUserEmail.equals(userDTO.getEmail())) {
                        String description = userDTO.getEmail() + " has deleted his/her comment on your post";
                        NotificationDTO notificationDTO = new NotificationDTO(description, articleUserEmail, userDTO.getEmail(), articleID);
