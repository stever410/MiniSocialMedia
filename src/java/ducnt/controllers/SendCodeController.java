...
public class SendCodeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = prop.getDispatcherValue(MEMBER_PAGE);
        try {
            ...
            if (userDTO != null) {
                ...
                MailUtil.sendEmail(userDTO.getEmail(), code);
                session.setAttribute("VERIFICATION_CODE", code);
                url = prop.getDispatcherValue(VERIFICATION_PAGE);
            }
        } catch (Exception e) {
