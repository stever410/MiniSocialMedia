    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (userDTO != null) {
                ...
                CommentDTO dto = new CommentDTO(articleID, currentUserEmail, comment);
                CommentDAO dao = new CommentDAO();
                if (dao.addCommentToArticle(dto)) {
                    if (!currentUserEmail.equals(articleUserEmail)) {
                        String description = currentUserEmail + " has commented on your post: " + comment;
